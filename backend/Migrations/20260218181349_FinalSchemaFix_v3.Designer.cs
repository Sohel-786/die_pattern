...
namespace net_backend.Migrations
{
    ...
    [Migration("20260218181349_FinalSchemaFix_v3")]
    partial class FinalSchemaFix_v3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("net_backend.Models.PatternChangeLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("pattern_change_logs");
                });

            modelBuilder.Entity("net_backend.Models.PatternDie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("pattern_dies");
                });

            modelBuilder.Entity("net_backend.Models.PatternStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("pattern_statuses");
                });

            modelBuilder.Entity("net_backend.Models.PatternType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("net_backend.Models.UserPermission", b =>
                {
                    ...
                    b.Property<bool>("ManageMaster")
                        .HasColumnType("bit");

                    b.Property<bool>("ManageUsers")
                        .HasColumnType("bit");

                    b.Property<bool>("PerformQC")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("net_backend.Models.Movement", b =>
                {
                    ...
                    b.HasOne("net_backend.Models.PatternDie", "PatternDie")
                        .WithMany()
                        .HasForeignKey("PatternDieId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("net_backend.Models.PatternDie", b =>
                {
                    ...
                    b.HasOne("net_backend.Models.PatternType", "PatternType")
                        .WithMany()
                        .HasForeignKey("PatternTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("net_backend.Models.PatternStatus", "Status")
                        .WithMany()
