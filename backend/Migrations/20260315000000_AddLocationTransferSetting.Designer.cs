...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("net_backend.Models.JobWork", b =>
                {
                    ...
                    b.HasIndex("LocationId", "JobWorkNo")
                        .IsUnique();
            ...
            modelBuilder.Entity("net_backend.Models.LocationTransferSetting", b =>
                {
                    b.Property<int>("LocationId")
                        .HasColumnType("int");

                    b.Property<bool>("AllowVendorToVendorTransfer")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("location_transfer_settings");
                });
            ...
            modelBuilder.Entity("net_backend.Models.Transfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("net_backend.Models.TransferItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("net_backend.Models.UserPermission", b =>
                {
                    ...
                    b.Property<bool>("CreateTransfer")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ViewInwardReport")
                        .HasColumnType("bit");

                    b.Property<bool>("ViewItemLedgerReport")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("net_backend.Models.TransferItem", b =>
                {
                    ...
                    b.HasOne("net_backend.Models.Transfer", "Transfer")
                        .WithMany("Items")
