...
namespace net_backend.Controllers
{
    ...
    public class DashboardController : BaseController
    {
        ...
        public async Task<ActionResult<ApiResponse<object>>> GetMetrics()
        {
            ...
            var itemsAtVendor = await _context.Items.CountAsync(p => p.LocationId == locationId && (p.CurrentProcess == ItemProcessState.InJobwork || p.CurrentProcess == ItemProcessState.AtVendor) && p.IsActive);
