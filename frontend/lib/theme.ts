...
export function applyPrimaryColor(hex: string | null | undefined): void {
    ...
    root.style.setProperty("--color-primary", shades["DEFAULT"]); // Also set --color-primary for v4 compat
    root.style.setProperty("--color-primary-50", shades["50"]); // Prefix with color- for v4
    ...
    // Also set legacy --primary-* just in case
