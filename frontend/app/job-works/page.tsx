                                ...
                                jobWorks.map((jw, idx) => (
                                    <Fragment key={jw.id}><TableRow
                                            className={cn(
                                                ...
                                                expandedJWId === jw.id ? "bg-primary-50/60 dark:bg-primary-900/30 border-none dark:border-transparent" : "border-b border-secondary-100 dark:border-secondary-800 hover:bg-primary-50/30 dark:hover:bg-primary-900/10",
                                                !jw.isActive && "bg-secondary-50/50 dark:bg-secondary-900/40 opacity-75"
                                            )}
