                                    ...
                                    {isLoading ? (
                                        ...
                                        filteredUsers.map((user, idx) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-3">
                                                    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border ${user.role === Role.ADMIN ? 'bg-rose-50 text-rose-700 border-rose-200 dark:bg-rose-950/20 dark:text-rose-500 dark:border-rose-800/50' :
                                                        user.role === Role.MANAGER ? 'bg-indigo-50 text-indigo-700 border-indigo-200 dark:bg-indigo-950/20 dark:text-indigo-400 dark:border-indigo-800/50' :
