    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                head_row: "flex",
                head_cell:
                    "text-secondary-500 rounded-md w-9 font-normal text-[0.8rem] flex justify-center items-center",
                ...
                day_outside:
                    "day-outside text-secondary-500 opacity-50 aria-selected:bg-secondary-100/50 aria-selected:text-secondary-500 aria-selected:opacity-30",
